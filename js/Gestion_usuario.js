$(document).ready(function() {
                  ...
                  <div class="row">
                    <div class="col-7">
                      ...
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-user"></i></span> Usuario: ${usuario.usuario}</li>
                    ...
                    if(tipo_usuario == 3){
                        if(usuario.tipo_usuario!=3){
                            ...
                            if(usuario.tipo_usuario==2){
                                ...
                                <i class="fas fa-user-edit mr-1"></i>Ascender
                                </button>`;
                            }
                        }
                    }
    ...
    $('#form-crear').submit(e => {
      ...
      $.post('../controlador/UsuarioController.php', {nombre, apellido, edad, usuario, pass, funcion}, (response) => {
        if(response=='add'){
          $('#add').hide('slow');
          $('#add').show(1000);
          $('#add').hide(2000);
